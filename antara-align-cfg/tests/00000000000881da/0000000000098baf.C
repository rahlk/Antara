...
int main(){
    ...
    for(int qi=0;qi<q;qi++){
        ...
        char cmd = DOK[2*n-3];
        int SURVI=0;
        int posdok[3]={0,0,0};int poslao[3]={0,0,0};
        while(!(posdok[0]>=n-1&&posdok[1]>=n-1&&poslao[0]>=n-1&&poslao[1]>=n-1)){

            if(n-1-poslao[0]+n-1-poslao[1]==1){
                if(poslao[0]+1<=n-1){LAO[poslao[2]]='S';poslao[2]++;}
                else {LAO[poslao[2]]='E';poslao[2]++;}
            }
            else if(cmd=='S'){

                  if(posdok[0]==poslao[0]&&posdok[1]==poslao[1]){
                      if(DOK[posdok[2]]!='S'){LAO[poslao[2]]='S';poslao[2]++;SURVI=1;}
                      else {LAO[poslao[2]]='E';poslao[2]++;}
                  }
                  else if(DOK[posdok[2]]=='E'&&SURVI==0){LAO[poslao[2]]='S';poslao[2]++;}
                  else{
                    if(poslao[1]+1<=n-1&&DOK[posdok[2]]=='E'){LAO[poslao[2]]='E';poslao[2]++;}
                  ...
                  if(posdok[0]==poslao[0]&&posdok[1]==poslao[1]){
                      if(DOK[posdok[2]]!='E'){LAO[poslao[2]]='E';poslao[2]++;SURVI=1;}
                      else {LAO[poslao[2]]='S';poslao[2]++;}
                  }
                  else if(DOK[posdok[2]]=='S'&&SURVI==0){LAO[poslao[2]]='E';poslao[2]++;}
                  else{
                    if(poslao[0]+1<=n-1&&DOK[posdok[2]]=='S'){LAO[poslao[2]]='S';poslao[2]++;}
                    else  {LAO[poslao[2]]='E';poslao[2]++;}
                  }
            }
