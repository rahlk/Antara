...
int main() {
	...
	long int* orderedPrimes;
	int i, j, k, index, isRepeat;
	long int aux;

	crypt = malloc(MAX_SIZE * sizeof(long int));
	primes = malloc(MAX_SIZE * sizeof(long int));
	orderedPrimes = malloc(ALPHABET_SIZE * sizeof(long int));
