...
int main() {
	int t, n, l;
	unsigned long long int* crypt;
	unsigned long long int* primes;
	unsigned long long int prime1, prime2;
	unsigned long long int* orderedPrimes;
	int i, j, k, index, isRepeat;
	unsigned long long int aux;

	crypt = malloc(MAX_SIZE * sizeof(unsigned long long int));
	primes = malloc(MAX_SIZE * sizeof(unsigned long long int));
	orderedPrimes = malloc(ALPHABET_SIZE * sizeof(unsigned long long int));
