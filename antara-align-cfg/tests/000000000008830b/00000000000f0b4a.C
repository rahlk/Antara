...
int main()
{
    ...
    char answer[100][100];
    int i,j,testcase,upperlim,l[100],input[100][100],primeused[100][200],reqprime[100][26],prime,t,k,d,b;
    scanf("%d",&testcase);
    ...
    for(i=0;i<testcase;i++)
    {
        ...
        returnuniqueprime(primeused[i],k-1,reqprime[i]);
