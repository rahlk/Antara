...
void sort(unsigned long long x[], unsigned len);
void removeDuplicates(unsigned long long x[], unsigned long long d[], unsigned len);
unsigned char decipher(unsigned long long idx[], unsigned long long num, unsigned len);
