	...
	for (caseCount = 1; caseCount <= caseNum; caseCount++) {
		...
		if ((R == 2 && C <= 4) || (R == 3 && C <= 3) || (R == 4 && C == 2) || (R == 5 && C == 2)) {
			...
			if (R == 3 && C == 4) {
				...
				move[2][0] = 2; move[2][1] = 0;
				move[3][0] = 0; move[3][1] = 2;
				move[4][0] = 2; move[4][1] = 1;
				move[5][0] = 1; move[5][1] = 3;
				move[6][0] = 0; move[6][1] = 1;
				move[7][0] = 2; move[7][1] = 2;
				move[8][0] = 1; move[8][1] = 0;
				move[9][0] = 0; move[9][1] = 3;
				move[10][0] = 1; move[10][1] = 1;
				move[11][0] = 2; move[11][1] = 3;
			} else if (R == 3 && C == 5) {
				move[0][0] = 1; move[0][1] = 4;
				move[1][0] = 0; move[1][1] = 0;
				move[2][0] = 1; move[2][1] = 2;
				move[3][0] = 2; move[3][1] = 0;
				move[4][0] = 0; move[4][1] = 2;
				move[5][0] = 2; move[5][1] = 3;
				move[6][0] = 0; move[6][1] = 4;
				move[7][0] = 2; move[7][1] = 1;
				move[8][0] = 1; move[8][1] = 3;
				move[9][0] = 0; move[9][1] = 1;
				move[10][0] = 2; move[10][1] = 2;
				move[11][0] = 1; move[11][1] = 0;
				move[12][0] = 0; move[12][1] = 3;
				move[13][0] = 1; move[13][1] = 1;
				move[14][0] = 2; move[14][1] = 4;
			} else {
				for (w = 1; w < C; w++) {
					int visited[20][20] = {{0}};
					int cr = 0, cc = 0;
