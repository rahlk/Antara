...
#define FZTE(i,n)	for(i16f i=0;i<n;i++)
#define FZTI(i,n)	for(i16f i=0;i<=n;i++)
#define FOTE(i,n)	for(i16f i=1;i<n;i++)
#define FOTI(i,n)	for(i16f i=1;i<=n;i++)
#define FATO(i,n)	for(i16f i=n;i>0;i--)
