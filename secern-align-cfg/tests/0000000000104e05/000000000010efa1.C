    ...
    for (Q = 1; Q <= T; Q++) {
        ...
        if (!best && N >= 4) {
            if (N == 6) {
                ...
                if (try4(words, 0, 1, 2, 5) || try4(words, 0, 2, 1, 5) || try4(words, 0, 5, 1, 2)) {
                    best = 4;
                    goto tried4;
                }
                
                if (try4(words, 0, 1, 5, 3) || try4(words, 0, 5, 1, 3) || try4(words, 0, 3, 1, 5)) {
                    best = 4;
                    goto tried4;
                }
                
                if (try4(words, 0, 5, 2, 3) || try4(words, 0, 2, 5, 3) || try4(words, 0, 3, 5, 2)) {
                    best = 4;
                    goto tried4;
                }
                
                if (try4(words, 5, 1, 2, 3) || try4(words, 5, 2, 1, 3) || try4(words, 5, 3, 1, 2)) {
                    best = 4;
                    goto tried4;
                }
            } else {
